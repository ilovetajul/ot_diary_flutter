            ...
            _tile('🚪', 'লগআউট', 'অ্যাকাউন্ট থেকে বের হন',
              ...
              final ok = await showDialog<bool>(
                ...
                builder: (_) => AlertDialog(
                  ...
                  title: const Text('লগআউট?', style: TextStyle(color: AppColors.text)),
                  ...
                  actions: [
                    ...
                    TextButton(onPressed: () => Navigator.pop(context, true),
                        child: const Text('হ্যাঁ', style: TextStyle(color: AppColors.red))),
                  ],
                ),
              );
              if (ok == true) {
  ...
  Widget _settingsCard(List<Widget> children) => Container(
    ...
    child: Column(children: children.map((w) {
      ...
      return Column(children: [
        w,
        if (idx < children.length - 1) const Divider(height: 1, color: AppColors.border),
      ]);
    }).toList()),
  );

  Widget _tile(String icon, String title, String sub, Color color, VoidCallback onTap) {
    return ListTile(
      onTap: onTap,
      leading: Container(width: 40, height: 40,
        decoration: BoxDecoration(
      ...
      subtitle: Text(sub, style: TextStyle(color: AppColors.muted, fontSize: 12)),
