...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _saveDay(int day, double hours) async {
    setState(() { _saving = true; if (hours == 0) _otData.remove(day); else _otData[day] = hours; });
    await DatabaseService.saveOTDay(_currentYear, _currentMonth + 1, day, hours);
          ...
          sliver: SliverList(delegate: SliverChildListDelegate([
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              TextButton.icon(
                ...
                label: const Text('রিসেট', style: TextStyle(color: AppColors.red, fontSize: 12)),
  ...
  Widget _tag(String text, {bool accent = false}) {
    return Container(
      ...
      child: Text(text,
        style: TextStyle(fontSize: 11, color: accent ? AppColors.accent : AppColors.text2,
  ...
  Widget _dayRow(int day) {
    ...
    final isFri = dow == 5, isSat = dow == 6;
    final hours = _otData[day] ?? 0.0;
    final hasOT = hours > 0;
    final today = DateTime.now();
    final isToday = day == today.day &&
        _currentMonth == today.month - 1 && _currentYear == today.year;
          ...
          SizedBox(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(
                    color: hasOT ? AppColors.accent.withOpacity(0.4) : AppColors.border),
                ),
              ...
              onChanged: (v) {
                ...
                setState(() { if (val == 0) _otData.remove(day); else _otData[day] = val; });
              },
              onEditingComplete: () {
